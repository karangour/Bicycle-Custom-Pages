...
import data_file from "./jsons/ecommerce_data.json";
import business_file from "./jsons/ecommerce_business.json";
...
function TravelPage() {
  ...
  const { name, email, interest, organization, selectedVertical } = location.state || {};
